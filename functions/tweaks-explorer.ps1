...
function Invoke-ExplorerThisPCApply {
    ...
    Write-Host "Removing `"Desktop`" from `"This PC`"..."
    ...
    Write-Host "Removing `"Documents`" from `"This PC`"..."
    ...
    Write-Host "Removing `"Downloads`" from `"This PC`"..."
    ...
    Write-Host "Removing `"Music`" from `"This PC`"..."
    ...
    Write-Host "Removing `"Pictures`" from `"This PC`"..."
    ...
    Write-Host "Removing `"Videos`" from `"This PC`"..."
